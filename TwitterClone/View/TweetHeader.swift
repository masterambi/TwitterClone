...
//  TwitterClone
//
//  Created by Ramzy Rashaun Arief on 04/06/20.
...
class TweetHeader: UICollectionReusableView {
    ...
    private lazy var statsView: UIView = {
        ...
        dividerTop.anchor(top: view.topAnchor, left: view.leftAnchor,
                          right: view.rightAnchor, paddingLeft: 16, paddingRight: 16, height: 1.0)
        
        let dividerBottom = UIView()
        dividerBottom.backgroundColor = .systemGroupedBackground
        view.addSubview(dividerBottom)
        dividerBottom.anchor(left: view.leftAnchor, bottom: view.bottomAnchor,
                             right: view.rightAnchor, paddingLeft: 16, paddingRight: 16, height: 1.0)
        ...
        stack.anchor(top: dividerTop.bottomAnchor, left: view.leftAnchor, bottom: dividerBottom.topAnchor,
    ...
    override init(frame: CGRect) {
        ...
        statsView.anchor(top: dateLabel.bottomAnchor, left: leftAnchor, right: rightAnchor, paddingTop: 16)
